...
# Each of these functions below return a different type of headline.
def generateAreMillenialsKillingHeadline():
    noun = random.choice(NOUNS)
    return 'Are Millenials Killing the {} Industry'.format(noun)  # Check whether capitalize works on this function!!
...
def generateReasonsWhyHeadline():
    ...
    return ('{} Reasons Why {} Are Interesting Than You Think (Number {} Will Shock You!)'
